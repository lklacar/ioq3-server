...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 2358704,
    DYNAMIC_BASE = 7601584,
    DYNAMICTOP_PTR = 2358544;
...
var wasmBinaryFile = 'q3_server.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function _VM_CallCompiled(
  ) {
  err('missing function: VM_CallCompiled'); abort(-1);
  }

  function _VM_Compile(
  ) {
  err('missing function: VM_Compile'); abort(-1);
  }
  ...
  var ___tm_current=2358560;
  
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 2358608, 4), 2358608);function _localtime_r(time, tmPtr) {
      _tzset();
...
var asmGlobalArg = {};
var asmLibraryArg = { "VM_CallCompiled": _VM_CallCompiled, "VM_Compile": _VM_Compile, "__assert_fail": ___assert_fail, "__lock": ___lock, "__syscall10": ___syscall10, "__syscall102": ___syscall102, "__syscall122": ___syscall122, "__syscall14": ___syscall14, "__syscall142": ___syscall142, "__syscall183": ___syscall183, "__syscall195": ___syscall195, "__syscall199": ___syscall199, "__syscall20": ___syscall20, "__syscall220": ___syscall220, "__syscall221": ___syscall221, "__syscall3": ___syscall3, "__syscall39": ___syscall39, "__syscall4": ___syscall4, "__syscall40": ___syscall40, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__unlock": ___unlock, "abs": _abs, "asctime": _asctime, "clock": _clock, "ctime": _ctime, "dlclose": _dlclose, "dlerror": _dlerror, "dlopen": _dlopen, "dlsym": _dlsym, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_longjmp": _emscripten_longjmp, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "gai_strerror": _gai_strerror, "getTempRet0": _getTempRet0, "getaddrinfo": _getaddrinfo, "gethostbyname": _gethostbyname, "getnameinfo": _getnameinfo, "getpwuid": _getpwuid, "gettimeofday": _gettimeofday, "invoke_i": invoke_i, "invoke_ii": invoke_ii, "invoke_iii": invoke_iii, "invoke_iiii": invoke_iiii, "invoke_v": invoke_v, "invoke_vi": invoke_vi, "invoke_viffi": invoke_viffi, "invoke_vii": invoke_vii, "kill": _kill, "localtime": _localtime, "memory": wasmMemory, "round": _round, "saveSetjmp": _saveSetjmp, "setTempRet0": _setTempRet0, "signal": _signal, "table": wasmTable, "testSetjmp": _testSetjmp, "time": _time, "usleep": _usleep };
var asm = createWasm();
...
var real_dynCall_iiiiiiiiiifiii = asm["dynCall_iiiiiiiiiifiii"];
asm["dynCall_iiiiiiiiiifiii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iiiiiiiiiifiii.apply(null, arguments);
};
...
var real_dynCall_fiiff = asm["dynCall_fiiff"];
asm["dynCall_fiiff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_fiiff.apply(null, arguments);
};
