...
Com_Printf(const char *fmt, ...) __attribute__ ((format (printf, 1, 2)));

void QDECL

Com_DPrintf(const char *fmt, ...) __attribute__ ((format (printf, 1, 2)));

void QDECL

Com_Error(int code, const char *fmt, ...) __attribute__ ((noreturn, format(printf, 2, 3)));
...
Com_strCompare(const void *a, const void *b);
...
Sys_LoadGameDll(const char *name, intptr_t (QDECL
...
Sys_Error(const char *error, ...) __attribute__ ((noreturn, format (printf, 1, 2)));
